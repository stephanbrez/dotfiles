# Alias to "lazy load" conda by initializing conda only when called
# instead of on shell startup
# By AaronnBrock: https://www.reddit.com/r/zsh/comments/qmd25q/lazy_loading_conda/
