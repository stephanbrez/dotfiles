...
alias zaliases="nvim $ZDOTDIR/aliases.d/00-base.zsh"     # Edit zsh aliases
alias zfunctions="nvim $ZDOTDIR/functions.d/00-base.zsh" # Edit zsh functions
...
alias extr="extract"                # functions.d/00-base.zsh
alias extrr='extract_and_remove '   # functions.d/00-base.zsh
...
alias mmr="micromamba run"                            # Run an executable in the environment
...
alias hrd="headroom dashboard"                                                                      # Display headroom dashboard
alias hrp="headroom perf"                                                                           # Print headroom performance report
...
# More in $ZDOTDIR/functions.d/00-base.zsh
...
alias uvsa="uv sync --active"           # Sync the project's dependencies with the active environment
